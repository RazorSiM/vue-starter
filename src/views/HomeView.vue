...
<template>
  <div class="flex gap-2">
    <a v-for="badge in badges" :key="badge.title" :href="badge.url" target="_blank" class="transition hover:(scale-105)">
  ...
  <div class="text-xl prose dark:prose-light">
    ...
    <p>Here's a list of what's included in this template. Everything has been configured to work out of the box with Eslint, Typescript and VScode.</p>
    <h3 id="features">
      Features
    </h3>
    <ul>
      ...
      <li>
        ...
        <ul>
          <li>
            <a target="_blank" href="https://github.com/unocss/unocss#style-resetting">@unocss/reset</a>
            with Tailwind settings;
          </li>
          <li>
            <a target="_blank" href="https://github.com/unocss/unocss/tree/main/packages/preset-uno">@unocss/preset-uno</a>
            as a base preset;
          </li>
          <li>
            <a target="_blank" href="https://github.com/unocss/unocss/tree/main/packages/preset-icons">@unocss/preset-icons</a>
            to use icons from
            <a target="_blank" href="https://icones.js.org/">Icones</a>;
          </li>
          <li>
            <a target="_blank" href="https://github.com/unocss/unocss/tree/main/packages/preset-typography">@unocss/preset-web-fonts</a>
            so you can grab your web fonts and set them up easily;
          </li>
          <li>
            <a target="_blank" href="https://github.com/unocss/unocss/tree/main/packages/transformer-variant-group">@unocss/transformer-variant-group</a>
            to use the <code>group</code> variant; ex: <code>hover:(bg-blue-500 text-white font-bold)</code>;
          </li>
        </ul>
      </li>
    ...
    <ul>
      ...
      <li>
        <a target="_blank" href="https://github.com/antfu/unplugin-vue-components">Unplugin Vue Components</a>
    ...
    <p>
      ...
      <a target="_blank" href="https://marketplace.visualstudio.com/items?itemName=Vue.volar">Volar</a>
      (and disable Vetur) +
      <a target="_blank" href="https://marketplace.visualstudio.com/items?itemName=Vue.vscode-typescript-vue-plugin">TypeScript Vue Plugin (Volar)</a>.
    </p>
    <h2 id="type-support-for-vue-imports-in-ts">
      Type Support for <code>.vue</code> Imports in TS
    </h2>
    <p>
      TypeScript cannot handle type information for <code>.vue</code> imports by default, so we replace the <code>tsc</code> CLI with <code>vue-tsc</code> for type checking. In editors, we need
      <a target="_blank" href="https://marketplace.visualstudio.com/items?itemName=Vue.vscode-typescript-vue-plugin">TypeScript Vue Plugin (Volar)</a>
    ...
    <p>
      ...
      <a target="_blank" href="https://github.com/johnsoncodehk/volar/discussions/471#discussioncomment-1361669">Take Over Mode</a>
    ...
    <p>This runs the end-to-end tests against the Vite development server. It is much faster than the production build.</p>
    <p>
...
pnpm run test:e2e
    ...
    <h3 id="lint-fix-and-format-with-eslint-and-antfueslint-config-settings">
      ...
      <a target="_blank" href="https://eslint.org/">ESLint</a> and @antfu/eslint-config settings
    </h3>
